...
export function TemplateCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex items-center gap-3 rounded-card border-[1.5px] border-joyna-border bg-white p-4 text-left transition-colors hover:border-joyna-border-strong',
        className,
      )}
    >
      {template.icon && (
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        ...
        {summary && (
          <span className="truncate text-xs text-joyna-ink-faint">
            {summary}
          </span>
        )}
      </div>
...
export function AddTemplateCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex items-center gap-3 rounded-card border-[1.5px] border-dashed border-joyna-border-strong bg-transparent p-4 text-left transition-colors hover:bg-white',
        className,
      )}
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        ...
        <span className="text-xs text-joyna-ink-faint">{description}</span>
      </div>
      <CardChevron />
    </button>
  )
